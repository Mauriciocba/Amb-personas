...
public class ListadoPersonas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<table border=1><tr><th>Nombre</th><th>Apellido</th><th>Estado Civil</th></tr>");

            GestorPersonas gestor = new GestorPersonas();
            ArrayList<Persona> lista = gestor.obtenerTodos();

            for (Persona persona : lista) {
               out.println("<tr><td>" + persona.getNombre() + "</td><td>" + persona.getApellido() + "</td><td>" + persona.getEstadoCivil().getNombre() + "</td></tr>");
            }
