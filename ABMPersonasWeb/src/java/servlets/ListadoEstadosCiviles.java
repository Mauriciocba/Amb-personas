 ...
 * @author diego
 */
@WebServlet(name = "ListadoEstadosCiviles", urlPatterns = {"/ListadoEstadosCiviles"})
public class ListadoEstadosCiviles extends HttpServlet {
    ...
    protected void responder(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListadoEstadosCiviles</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Listado de estados civiles</h1>");
            out.println("<table border=1><tr><th>Numero</th><th>Nombre</th></tr>");
